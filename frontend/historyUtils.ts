type HistoryRow = {
  ...
  seat_index?: number | string | null;
};

type ParticipantNameById = {
  get(key: string): unknown;
};

type RuntimeGlobal = typeof globalThis & {
  resolveHistoryRowName?: (
    row: HistoryRow | null | undefined,
    participantNameById: ParticipantNameById | null | undefined,
    fallbackNames: readonly string[] | null | undefined,
  ) => string;
};
...
(function (global: RuntimeGlobal) {
  function resolveHistoryRowName(
    row: HistoryRow | null | undefined,
    participantNameById: ParticipantNameById | null | undefined,
    fallbackNames: readonly string[] | null | undefined,
  ): string {
